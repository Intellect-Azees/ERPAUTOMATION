 ...
 */
    ...
    public void TestCase1() throws Exception
    {
    	...
    	Thread.sleep(5000);
    	//enrollMember.enrollMember("Nominal Member","Azees", "A", "623281555606", "Azees","25");
    	enrollMember.enrollMember("Nominal Member",datagen.getLastName(),datagen.getFirtName()
    			);
    }
}
